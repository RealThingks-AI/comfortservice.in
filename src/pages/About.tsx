      ...
      <div className="container-wide">
        <div className="text-center mb-10">
          ...
          {CONTACT_INFO.ownerName && (
            <p className="text-muted-foreground text-sm mt-1">
              Proprietor: <span className="font-medium text-foreground">{CONTACT_INFO.ownerName}</span>
            </p>
          )}
        </div>
        ...
        <div className="max-w-2xl mx-auto mb-12">
          <div className="bg-accent rounded-lg p-6">
            ...
            <div className="space-y-3 text-sm text-muted-foreground">
              <p>
                {CONTACT_INFO.companyName} has been providing professional AC services in the Pune region since 2018.{" "}
                {CONTACT_INFO.experienceText}, delivering reliable installation, maintenance, and repair services with
                outstanding customer care.
              </p>
              <p>
                We place a high priority on providing outstanding customer service through prompt and dependable
                repairs, open communication, and affordable prices.
              </p>
              <p>
                We facilitate flawless living and operational excellence; we are more than just a repair service. We
                want to create long-lasting connections that endure by keeping the greatest standards of
                professionalism, ethics, and customer care.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="relative max-w-3xl mx-auto">
            ...
            {milestones.map((milestone, index) => (
              <div
                key={milestone.year}
                className={`relative flex items-start mb-6 last:mb-0 ${index % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"}`}
              >
        ...
        <div className="bg-accent rounded-lg p-6 text-center mb-12">
          ...
          <p className="text-muted-foreground text-sm max-w-xl mx-auto">
            Our team consists of certified and experienced AC technicians who undergo regular training to stay updated
