...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative overflow-hidden min-h-[300px] md:min-h-[600px] flex items-center bg-gradient-to-br from-background via-accent to-background">
      ...
      <div className="container mx-auto px-2 md:px-4 relative z-20 py-6 md:py-28">
        ...
        >
          ...
          {/* Subheading */}
          <motion.p 
            className="text-xs md:text-xl lg:text-2xl mb-1.5 md:mb-4 text-foreground/90"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          {/* Description */}
          <motion.p 
            className="text-xs md:text-base mb-3 md:mb-8 max-w-2xl mx-auto text-muted-foreground"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          {/* GSTIN with Copy */}
          <motion.div 
            className="flex items-center justify-center gap-1 md:gap-2 text-xs md:text-sm text-muted-foreground"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            <button
              ...
              className="p-1 md:p-1.5 hover:bg-accent rounded-md transition-colors"
